...
/* config */
#define CONFIG_XENO_BUILD_ARGS " 'CFLAGS=-march=armv7-a -mtune=cortex-a8 -mfloat-abi=hard -mfpu=neon -ffast-math' '--host=arm-linux-gnueabihf' '--target=arm-linux-gnueabihf' '--enable-smp' 'host_alias=arm-linux-gnueabihf' 'target_alias=arm-linux-gnueabihf' 'PKG_CONFIG_PATH=/opt/ros/kinetic/lib/pkgconfig'"
